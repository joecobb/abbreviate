...
(function() {
  ...
  module.exports = function(str, arg) {
    var chars, di, exclude, found, i, j, k, keepSeparators, l, len, len1, length, newWord, order, orderedCount, pattern, pos, ref, ref1, sep, should, strict, tri, unfinished, word, words;
    length = arg.length, keepSeparators = arg.keepSeparators, strict = arg.strict, exclude = arg.exclude;
    if (length == null) {
      length = 3;
    }
